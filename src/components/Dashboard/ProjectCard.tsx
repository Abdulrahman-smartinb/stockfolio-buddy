...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.25, delay: index * 0.05 }}
      className={cn(
        "group cursor-pointer overflow-hidden rounded-[28px] border border-border/70 bg-card shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg",
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-background via-card to-muted/30 p-5">
        ...
        <div className="relative flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 min-w-0">
            <div
              className={cn(
                "rounded-2xl border border-border/80 bg-background flex items-center justify-center overflow-hidden shrink-0 shadow-sm",
